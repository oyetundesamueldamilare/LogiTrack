...
namespace LogiTrack.Migrations
{
    ...
    [Migration("20260514182832_RefactoredOrderAndPayments")]
    partial class RefactoredOrderAndPayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogiTrack.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("LogiTrack.Models.Order", b =>
                {
                    b.HasOne("LogiTrack.Models.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LogiTrack.Models.AppUser", null)
                        .WithMany()
